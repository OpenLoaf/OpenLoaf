  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[314px] rounded-3xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-3xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[307px] rounded-3xl blur-[2px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[303px] rounded-3xl blur-[0.5px] 
        ...
        <div id="main" className="relative group">
          <input placeholder="Search..." type="text" name="text" className="bg-[#010201] border-none w-[301px] h-[56px] rounded-3xl text-white px-[59px] text-lg focus:outline-none placeholder-gray-400" />
          ...
          <div className="absolute h-[42px] w-[40px] overflow-hidden top-[7px] right-[7px] rounded-3xl
          ...
          <div id="filter-icon" className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-3xl bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] border border-transparent">
