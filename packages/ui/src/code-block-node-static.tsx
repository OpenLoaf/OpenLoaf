...
export function CodeBlockElementStatic(
  ...
  return (
    <SlateElement
      ...
      {...props}
    >
      <div className="relative rounded-3xl bg-muted/50">
        <pre className="overflow-x-auto p-8 pr-4 font-mono text-xs leading-[normal] [tab-size:2] print:break-inside-avoid">
