    ...
    switch (action) {
      ...
      case 'create': {
        ...
        const task = createTask(
          {
            ...
            skipPlanConfirm: input.skipPlanConfirm ?? true,
        ...
        if (isScheduled) {
          ...
          void scheduleOrchestrator.enqueue(task.id, projectRoot)
        }
      ...
      case 'run': {
        ...
        await scheduleOrchestrator.enqueue(input.taskId, projectRoot)
