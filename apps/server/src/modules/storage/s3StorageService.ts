import type { S3ObjectTagging, S3ProviderConfig, StorageObjectRef } from "@teatime-ai/api/types/storage";
import { DEFAULT_S3_EXPIRE_DAYS } from "@teatime-ai/api/types/storage";
