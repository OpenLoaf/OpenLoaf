...
it('001 — Read 纯文本，回复总结会议纪要', async () => {
  ...
  await takeProbeScreenshot('file-read-001-read-tool-text')
  const meta = { testCase: 'file-read-001-read-tool-text', prompt, result, description: 'Read 工具读文本附件，总结会议纪要', tags: ['read-tool'] }
