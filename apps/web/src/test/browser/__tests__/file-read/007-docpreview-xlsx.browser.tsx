...
it('004 — XLSX 全量，回复列出 sheet', async () => {
  ...
  await takeProbeScreenshot('file-read-007-docpreview-xlsx')
  const meta = { testCase: 'file-read-007-docpreview-xlsx', prompt, result, description: 'DocPreview 全量读取 XLSX', tags: ['docpreview', 'xlsx'] }
  ...
  const judgment = await aiJudge({
    testCase: 'file-read-007-docpreview-xlsx',
