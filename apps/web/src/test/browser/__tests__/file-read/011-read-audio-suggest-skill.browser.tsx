...
it('006 — 音频读取，回复有实质内容', async () => {
  ...
  await takeProbeScreenshot('file-read-011-read-audio-suggest-skill')
  const meta = { testCase: 'file-read-011-read-audio-suggest-skill', prompt, result, description: 'Read 读音频返回 suggest skill，不直连云服务', tags: ['read-tool', 'audio', 'suggest-skill'] }
