...
it('005 — 图片读取，回复描述图片', async () => {
  ...
  await takeProbeScreenshot('file-read-009-read-image-suggest-skill')
  const meta = { testCase: 'file-read-009-read-image-suggest-skill', prompt, result, description: 'Read 读图片返回 suggest skill，不直连云服务', tags: ['read-tool', 'image', 'suggest-skill'] }
