...
it('003 — DOCX 读取，回复描述文档内容', async () => {
  ...
  await takeProbeScreenshot('file-read-005-read-docx')
  const meta = { testCase: 'file-read-005-read-docx', prompt, result, description: 'Read 读 DOCX 返回统一预览信封格式', tags: ['read-tool', 'docx'] }
  ...
  const judgment = await aiJudge({
    testCase: 'file-read-005-read-docx',
