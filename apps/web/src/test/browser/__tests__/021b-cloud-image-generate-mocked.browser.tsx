...
it('021b — Cloud 图片生成 (mock 回放)', async () => {
  ...
  render(
    <ChatProbeHarness
      ...
      cloudMock={{ testCase: '021-cloud-image-generate', mode: 'mock' }}
    />,
  )
  ...
  await takeProbeScreenshot('021b-cloud-image-generate-mocked')
  const meta = {
    testCase: '021b-cloud-image-generate-mocked',
    prompt,
    result,
