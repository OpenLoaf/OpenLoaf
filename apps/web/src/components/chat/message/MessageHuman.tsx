...
export default function MessageHuman({
  ...
  return (
    <div className={cn("flex justify-end min-w-0", className)}>
      <div
        className="max-w-[80%] min-w-0 max-h-64 overflow-x-hidden overflow-y-auto show-scrollbar p-3 rounded-lg bg-primary/85 text-primary-foreground border border-primary/35 shadow-sm"
