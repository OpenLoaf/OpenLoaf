            ...
            <div className="divide-y divide-border">
              <div className="flex items-center justify-between gap-4 py-3">
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground">选择淡色或浅色</div>
                </div>
              ...
              <div className="flex items-center justify-between gap-4 py-3">
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground">跟随系统浅色/淡色</div>
                </div>
              ...
              <div className="flex items-center justify-between gap-4 py-3">
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground">小 / 中 / 大</div>
                </div>
