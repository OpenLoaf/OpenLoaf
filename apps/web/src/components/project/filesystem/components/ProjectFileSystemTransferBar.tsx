...
export default function ProjectFileSystemTransferBar({
  ...
  return (
    <div className="pointer-events-auto absolute bottom-4 right-4 z-20 flex flex-col gap-1 rounded-3xl border border-border/60 bg-background/90 px-3 py-2 text-xs shadow-sm">
