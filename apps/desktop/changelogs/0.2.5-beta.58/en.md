...
- **Desktop build**: Mark `skia-canvas` and `node-pptx-png-v2` as webpack externals so native modules resolve at runtime instead of being bundled (fixes the all-platform build break in beta.57)
